# -*- coding: utf-8 -*-
"""
Created on Fri Mar 17 13:29:05 2023
...
class Staff(User):
    ...
    def menu(self):
        '''
        EXECUTES STAFF MENU OF LIBRARY FUNCTIONS
...
""")
    ...
    def f_opt3(self):
        ...
        if self.db.view_status(isbn) != "issued":    
            ...
            if  books_borrowed != None:    
                ...
                if len(books_borrowed) < Staff.b_limit: 
    ...
    def f_opt4(self):
        ...
        if self.db.view_status(isbn) == "issued": # Checks if books is issued
            ...
            book = [self.db.getBooks(isbn), c_date_uk]
            ...
            for i , b in enumerate(self.acc.l_books_borrowed):
                ...
                if b[0] == self.db.getBooks(isbn):
                    ...
                    e = datetime.strptime(b_date, date_format)
                    delta = a - e
                    print(delta)
                    borrowed_book = [b[0], b[1]]
                    if delta.days >7:
                        
                        self.acc.l_lost_Books.append(book)
                        self.acc.l_books_borrowed.remove(borrowed_book)
